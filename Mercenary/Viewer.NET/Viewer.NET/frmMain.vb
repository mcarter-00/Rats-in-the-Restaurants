...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        '"https://raw.githubusercontent.com/mcarter-00/Rats-in-the-Restaurants/master/Resources/Clean/clean_inspections_again.csv"
    ...
    Private Sub cboColumnName_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboColumnName.SelectedIndexChanged
        ...
        lstSummaryView.Columns.Add("Average", 80, HorizontalAlignment.Left)
        lstSummaryView.Columns.Add("Median", 80, HorizontalAlignment.Left)
        lstSummaryView.Columns.Add("Stdev", 80, HorizontalAlignment.Left)
        lstSummaryView.Columns.Add("Min", 80, HorizontalAlignment.Left)
        lstSummaryView.Columns.Add("Max", 80, HorizontalAlignment.Left)
        ...
        Try
            ...
            For Each sRow As String In sFilteredData
                ...
                For iIdxCol = 1 To sColumnName.Length
                    dListData(iIdxCol - 1).Add(Val(sTmp(iIndex(iIdxCol - 1) - 2)))
                Next
            Next 'Grab data
